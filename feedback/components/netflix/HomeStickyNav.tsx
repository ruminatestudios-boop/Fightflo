...
export function HomeStickyNav({
  ...
  return (
    <nav className="home-sticky-nav" aria-label="Main navigation">
      ...
      >
        <span className="home-sticky-nav-tab-indicator" aria-hidden />
      ...
      <button
        type="button"
        className="home-sticky-nav-record"
        onClick={onRecord}
        aria-label="Live record with coaching"
      >
        <span className="home-sticky-nav-record-ring" aria-hidden>
          <span className="home-sticky-nav-record-dot" />
        </span>
        <span className="home-sticky-nav-record-label">Record</span>
      </button>
